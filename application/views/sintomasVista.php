...
<?php $this->load->helper('ajax_sintoma') ?>
<body>
						...
						<div class="fila">
							<div class="columna">
								<div class="entrada-grupo">
									<span class="input-group-text" ><i class="fa fa-tags" >&nbsp</i>Sintoma</span>
									<input type="text" class="form-control" aria-label="Small" value="" aria-describedby="inputGroup-sizing-sm" name="nombre_sintoma" id="sintoma">
								</div>
							</div>
						</div>		
					</form>
