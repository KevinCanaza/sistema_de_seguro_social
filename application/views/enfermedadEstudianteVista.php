...
<?php $this->load->helper('ajax_enfermedad_estudiante') ?>
<body>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a id="agregar">Añadir enfermedad para estudiante</a>
                            </div>
				...
				<div class="modal-cuerpo">
					<form action="" id="formulario" method="POST">
                        ...
                        <div class="fila">
						    ...
						    <div class="columna">
								<div class="entrada-grupo">
									<span class="input-group-text" ><i class="fa fa-tags" >&nbsp</i>Enfermedad</span>
									<select name="enfermedades" id="enfermedad" class="form-control">
