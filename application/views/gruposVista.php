...
<?php $this->load->helper('ajax_grupo') ?>
<body>
						...
						<div class="fila">
							<div class="columna">
								<div class="entrada-grupo">
									...
									<input type="text" class="form-control" aria-label="Small" value="" aria-describedby="inputGroup-sizing-sm" name="name" id="nombre">
								</div>
							</div>
							<div class="columna">
								<div class="entrada-grupo">
									<span class="input-group-text"><i class="fa fa-tags">&nbsp</i>Descripción</span>
									<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="description" id="descripcion">
								</div>
							</div>
						</div>				
					</form>
