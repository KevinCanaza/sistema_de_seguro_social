						    ...
						    <div class="columna">
								<div class="entrada-grupo">
									...
									<div class="image-preview">
										<img src="" alt="Imagen del estudiante" id="mostrar-aqui">
									</div>
									<label for="foto" id="subir-foto" class="btn btn-primary"></label>
									<input type="file" class="form-control" aria-label="Small" value="" aria-describedby="inputGroup-sizing-sm" name="foto" id="foto" style="display: none;">
								</div>
						    </div>
						</div>
