...
<?php $this->load->helper('ajax_doctor_especialidad') ?>
<body>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a id="agregar">Añadir una especialidad al doctor</a>
                            </div>
                        ...
                        <div class="fila">
							...
							<div class="columna">
								<div class="entrada-grupo">
									...
									<select name="especialidades" id="especialidad" class="form-control">
										<option value="">-- Seleccione un especialidad--</option>
									</select>
								</div>
							</div>
						</div>
