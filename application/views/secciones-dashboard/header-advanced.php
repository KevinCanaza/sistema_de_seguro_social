<div class="header-advance-area">
                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                    ...
                                                    <div role="menu" class="author-message-top dropdown-menu animated zoomIn">
                                                        ...
                                                        <ul class="message-menu">
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="<?=base_url('dashboard/')?>img/contact/1.jpg" alt="">
                                                                    </div>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="<?=base_url('dashboard/')?>img/contact/4.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Sulaiman din</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="<?=base_url('dashboard/')?>img/contact/3.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="<?=base_url('dashboard/')?>img/contact/2.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">16 Sept</span>
                                                                        <h2>Victor Jara</h2>
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="#"><span class="icon nalika-settings author-log-ic"></span> Ajustes</a>
                                                        </li>
                                                        <li><a href="<?=base_url('indexController/logout')?>"><span class="icon nalika-unlocked author-log-ic"></span> Cerrar sesión</a>
                                                        </li>
                                                    </ul>
                                                </li>
            ...
            <!-- Menu para modo bobil -->
            <?php $this->load->view('secciones-dashboard/mode-mobile') ?>
