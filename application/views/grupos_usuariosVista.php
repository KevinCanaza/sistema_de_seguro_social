...
<?php $this->load->helper('ajax_grupoUsuarios') ?>
<body>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a id="agregar">Añadir Grupo Usuario</a>
                            </div>
                        ...
                        <div class="fila">
							<div class="columna">
								<div class="entrada-grupo">
									...
									<select name="usuarios" id="usuario" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
							...
							<div class="columna">
								<div class="entrada-grupo">
									<span class="input-group-text" ><i class="fa fa-tags" >&nbsp</i>Grupo</span>
