	...
	<?php $this->load->helper('ajax_carrera') ?>
	<body>
							...
							<div class="fila">
								<div class="columna">
									<div class="entrada-grupo">
										...
										<input type="text" class="form-control" aria-label="Small" value="" aria-describedby="inputGroup-sizing-sm" name="nombre_carrera" id="carrera">
									</div>
								</div>
								<div class="columna">
									<div class="entrada-grupo">
										<span class="input-group-text"><i class="fa fa-tags">&nbsp</i>Área</span>
										<input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="area" id="area">
									</div>
								</div>
							</div>		
						</form>
