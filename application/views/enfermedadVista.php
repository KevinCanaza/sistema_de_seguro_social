...
<?php $this->load->helper('ajax_enfermedad') ?>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            <h4>Lista Enfermedades</h4>
                            <div class="add-product">
                                <a id="agregar">Añadir Enfermedad</a>
                            </div>
						...
						<div class="fila">
							<div class="columna">
								<div class="entrada-grupo">
									<span class="input-group-text" ><i class="fa fa-tags" >&nbsp</i>Nombre de la enfermadad</span>
									<input type="text" class="form-control" aria-label="Small" value="" aria-describedby="inputGroup-sizing-sm" name="nombre_enfermedad" id="enfermedad">
								</div>
							</div>
						</div>				
					</form>
