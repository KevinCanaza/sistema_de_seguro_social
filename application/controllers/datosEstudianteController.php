...
class datosEstudianteController extends Verificacion_Controller {
	...
	function __construct()
	{
		...
		$this->site_title='Estudiantes';
		$this->load->model('datosEstudianteModel');
	}
	public function index()
	{
		$this->load->view('datosEstudianteVista');
	}

	//Realizado peticion al modelo para nos devuelva datos
	public function get_datos_estudiante(){
		$respuesta = $this->datosEstudianteModel->get_datos_estudiante();
