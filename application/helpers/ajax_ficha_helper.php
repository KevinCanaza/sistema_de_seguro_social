<script>
	...
	$(document).ready(function(){
		...
		function mostrarDatos(){
			$.ajax({
				type: 'ajax',
				url: '<?= base_url('fichaController/get_ficha') ?>',
				dataType: 'json',
				...
				success: function(datos){
					...
					for(i=0; i<datos.length; i++){
                        ...
                        '<td>'+datos[i].hora_inicio+' '+datos[i].hora_fin+'</td>'+
						...
						'<td>'+datos[i].fecha_ficha+'</td>'+
						'<td>'+'<a href="javascript:;" class="edit" data="'+datos[i].id_ficha+'" > <button data-toggle="tooltip" title="Edit" class="pd-setting-ed"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>  '+
						'<td>'+'<a href="javascript:;" class="borrar" data="'+datos[i].id_ficha+'" > <button data-toggle="tooltip" title="Trash" class="pd-setting-ed"><i class="fa fa-trash-o" aria-hidden="true" ></i></button></a>'+
						'</tr>';
						n++;
        ...
        $('#formulario').attr('action','<?= base_url('fichaController/ingresar')?>');   
        });
        ...
        function get_servicio(){
            $.ajax({
                type: 'ajax',
                url: '<?= base_url('fichaController/get_servicio') ?>',
                dataType: 'json',
        ...
        function get_doctor(){
            $.ajax({
                type: 'ajax',
                url: '<?= base_url('fichaController/get_doctor') ?>',
                dataType: 'json',
        ...
        function get_estudiante(){
            $.ajax({
                type: 'ajax',
                url: '<?= base_url('fichaController/get_estudiante') ?>',
                dataType: 'json',
        ...
        function get_horario(){
            $.ajax({
                type: 'ajax',
                url: '<?= base_url('fichaController/get_horario') ?>',
                dataType: 'json',
